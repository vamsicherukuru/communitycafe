...
urlpatterns = [
    ...
    path('joincommunity/', views.CommunityRequestView,
    ...
    path('accept/<id>/<community_id>/<member>',
         views.acceptjoin, name='acceptjoin'),
    ...
    path('community/posts/<int:id>',
         views.CommunityPostHomeView, name='composthome'),
    path('community/posts/<int:id>/new/',
         views.CommunityPostFormView, name='newpost'),
    path('processcheckout/<int:id>/',
         views.ProcessOrderView, name='processcheckout'),
    ...
    path('myOrders/order/<int:id>/<user>/',
         views.OrdersDetail, name='orderdetail'),
    path('add/item/<int:id>/', views.AddRestaurantItemsView, name='additems'),
    path('homechef/food/available/today/<int:id>/',
         views.ManageTodaysMenuView, name='manage_today'),
    # path('update_item/', views.updateItem,name="update_item"),

    path('makeAvailable/<int:id>/', views.MakeAvailable, name='makeavailable'),
    path('makeunAvailable/<int:id>/',
         views.MakeUnAvailable, name='makeunavailable'),
    ...
    path('hobbies/groups/posts/<int:id>/new/',
         views.GroupPostFormView, name='newgrouppost'),
    path('group_requests/', views.UserRequestsView, name='group_requests'),
    path('hobbies/GroupRequestView',
         views.GroupRequestView, name='GroupRequestView'),
    path('groupapprovals/<int:id>/', views.GroupApprovalsView, name="grpapprovals"),
    path('acceptgrp/<id>/<group_id>/<member>',
         views.groupjoin, name='groupjoin'),
]
