...
class Pincode(models.Model):
		pincode = models.CharField(max_length=6, blank=True, null=True, unique = True)
		def __str__(self):
			return self.pincode
...
class Community(models.Model):
	...
	people = models.ManyToManyField(User, related_name='community_members', blank=True, null=True)
	# class Meta:
...
class KiranaStore(models.Model):
	...
	def __str__(self):
		return self.store_name + " (" + str(self.Area.Area_Name) + ", " + str(self.Area.pincode) + ")"
...
class businessReg(models.Model):
	...
	address=models.ForeignKey(Area, on_delete=models.SET_NULL, null=True, blank=True)
	verified = models.BooleanField(default=False)
	caption = models.CharField(max_length=200, blank=True, null=True)
	business_logo = models.ImageField(upload_to='business_reg_pics', blank=True, null=True)
	def __str__(self):
...
class RestaurantItems(models.Model):
	hotel = models.ForeignKey(businessReg, on_delete=models.CASCADE, blank=True, null=True)
	item_name = models.CharField(max_length=500, blank=True, null=True)
	price_per_unit = models.IntegerField(default=10)
	display_picture = models.ImageField(upload_to='food_images', blank=True, null=True)
...
class businessVerification(models.Model):
	...
	businessname=models.ForeignKey(businessReg, on_delete=models.SET_NULL, blank=True, null=True)
...
class TravelsUserBooking(models.Model):
	...
	destination = models.CharField(choices=destination_choices, max_length=100, default='')
...
class RestaurantOrders(models.Model):
	...
	item = models.ForeignKey(RestaurantItems, on_delete=models.SET_NULL, null=True, blank=True)
...
class OrderItem(models.Model):
	product = models.ForeignKey(RestaurantItems, on_delete=models.SET_NULL, blank=True, null=True)

	order = models.ForeignKey(Order, on_delete=models.SET_NULL, blank=True, null=True)
	quantity = models.IntegerField(default=0, null=True, blank=True)
	date_added = models.DateTimeField(auto_now_add=True, blank=True, null=True)
	cooking_instruction = models.CharField(max_length=500, blank=True, null=True) 
	def __str__(self):
...
class CommunityPosts(models.Model):
	...
	attachment_pic = models.ImageField(upload_to='community_posts_pics', blank=True, null=True)
...
class GiveBackReg(models.Model):
	owner_name=models.ForeignKey(User,blank=True,null=True,on_delete=models.CASCADE)
	resource_photo=models.ImageField(upload_to='give_back_photos',blank=True,null=True)
	resource_description=models.CharField(max_length=250,blank=True,null=True)
...
class GroupsReg(models.Model):
	...
	verified = models.BooleanField(default=False)
	caption = models.CharField(max_length=200, blank=True, null=True)
	group_logo = models.ImageField(upload_to='group_reg_pics', blank=True, null=True)
	people = models.ManyToManyField(User, related_name='group_members', blank=True, null=True)
...
class GroupPosts(models.Model):
	author = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True)
	timestamp = models.DateTimeField(auto_now_add=True)
	group = models.ForeignKey(GroupsReg, on_delete=models.SET_NULL, blank=True, null=True)
	title = models.CharField(max_length=500, blank=True, null=True)
	attachment_pic = models.ImageField(upload_to='group_posts_pics', blank=True, null=True)
	text_body = models.TextField(max_length=3000, blank=True, null=True)
...
class Comment(models.Model):
	post = models.ForeignKey(GroupPosts, related_name="comments", on_delete=models.CASCADE)
